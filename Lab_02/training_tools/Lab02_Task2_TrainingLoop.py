...
# ---------------------------------- MODIFY PART ---------------------------------- #
# Import model
from task2_model import CDenseNet

# Loop settings
MAX_LOOP      = 50
LOG_INFO_FILE = "task2_log.txt"
LOG_CSV_FILE  = "task2_log.csv"
FIG_FILE      = "task2_test_samples.png"
START_SEED    = 37

# Best settings
BEST_LOG_INFO_FILE = "task2_best_log.txt"
BEST_LOG_CSV_FILE  = "task2_best_log.csv"
BEST_SUMMARY_FILE  = "task2_best_summary.txt"
BEST_MODEL_FILE    = "task2_best_model.pth"
BEST_FIG_FILE      = "task2_best_test_samples.png"
# --------------------------------------------------------------------------------- #
...
def train_loop(seed: int) -> float:
    ...
    # Testing phase
    # ---------------------------------------------------------------------------------------------------- #
    _ckpt_path = ckpt_path if 'ckpt_path' in globals() else 'task2_model.pth'
    ...
    plt.tight_layout()
    plt.savefig("task2_test_samples.png", dpi=150)
    ...
    return avg_test_mae * 0.6 + saved_val_mae * 0.4
...
if __name__ == "__main__":
    # Initialization
    seed = START_SEED
    best_avg_test_mae = 2.0  # float('inf')
    ...
    for i in range(MAX_LOOP):
        ...
        if avg_test_mae < best_avg_test_mae:
            ...
            os.replace("task2_summary.txt", BEST_SUMMARY_FILE)
            os.replace("task2_model.pth", BEST_MODEL_FILE)
